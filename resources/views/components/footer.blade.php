<footer class="bg-clinic-ink text-white" id="localizacao">
    <div class="max-w-6xl mx-auto px-4 py-14 space-y-8">
        <div class="space-y-4 text-center">
            <p class="text-sm font-semibold uppercase tracking-[0.3em] text-[#9e8e7a]">Esperamos por você!</p>
        ...
        <div class="grid gap-6 text-sm text-center sm:grid-cols-2 lg:grid-cols-2">
            <div>
                <span class="font-semibold uppercase tracking-widest text-[#9e8e7a] text-xs">Endereço</span>
                <p class="mt-2 text-white/80">Rua Dom Domingos Carrerot, 1005 – Centro, Porto Nacional – TO, 77500-000</p>
            </div>
            <div>
                <span class="font-semibold uppercase tracking-widest text-[#9e8e7a] text-xs">Atendimento</span>
